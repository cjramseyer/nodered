...
var g = function g(k, jm, c1, c2) {
  ...
  var F = _base["default"].horner(T, 160.7108 * p, 390.67050284 * p / ck, -0.0016118 * p, -0.00000227 * p, 0.000000011 * p);
  ...
  var M = _base["default"].horner(T, 2.5534 * p, 29.1053567 * p / ck, -0.0000014 * p, -0.00000011 * p);

  var Mʹ = _base["default"].horner(T, 201.5643 * p, 385.81693528 * p / ck, 0.0107582 * p, 0.00001238 * p, -0.000000058 * p);

  var Ω = _base["default"].horner(T, 124.7746 * p, -1.56375588 * p / ck, 0.0020672 * p, 0.00000215 * p);

  var sΩ = Math.sin(Ω);
  var F1 = F - 0.02665 * p * sΩ;

  var A1 = _base["default"].horner(T, 299.77 * p, 0.107408 * p / ck, -0.009173 * p); // (54.1) p. 380
  ...
  var _base$sincos = _base["default"].sincos(F1),
...
function solar(year) {
  ...
  var _g = g(snap(year, 0), _moonphase["default"].meanNew(year), -0.4075, 0.1721),
...
function lunar(year) {
  ...
  var _g3 = g(snap(year, 0.5), _moonphase["default"].meanFull(year), -0.4065, 0.1727),
