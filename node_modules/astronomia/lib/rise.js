...
exports["default"] = exports.PlanetRise = exports.Stdh0Lunar = exports.stdh0Lunar = exports.Stdh0LunarMean = exports.stdh0LunarMean = exports.Stdh0Solar = exports.stdh0Solar = exports.Stdh0Stellar = exports.stdh0Stellar = exports.stdh0 = exports.meanRefraction = exports.errorBelowHorizon = exports.errorAboveHorizon = void 0;
...
var errorAboveHorizon = _base["default"].errorCode('always above horizon', -1);

exports.errorAboveHorizon = errorAboveHorizon;

var errorBelowHorizon = _base["default"].errorCode('always below horizon', 1);
/**
...
var meanRefraction = new _sexagesimal["default"].Angle(false, 0, 34, 0).rad();
/**
...
var stdh0 = {
  ...
  solar: new _sexagesimal["default"].Angle(true, 0, 50, 0).rad(),
  // not containing meanRefraction
  lunar: new _sexagesimal["default"].Angle(false, 0, 0, 0.7275).rad(),
  lunarMean: new _sexagesimal["default"].Angle(false, 0, 0, 0.125).rad()
};
/**
...
var stdh0Stellar = function stdh0Stellar(_refraction) {
  return refraction(stdh0.stellar, _refraction);
};

exports.stdh0Stellar = stdh0Stellar;
var Stdh0Stellar = stdh0Stellar(); // for backward-compatibility
...
var stdh0Solar = function stdh0Solar(_refraction) {
  return refraction(stdh0.solar, _refraction);
};

exports.stdh0Solar = stdh0Solar;
var Stdh0Solar = stdh0Solar(); // for backward-compatibility
...
var stdh0LunarMean = function stdh0LunarMean(_refraction) {
  return stdh0.lunarMean - refraction(_refraction);
};

exports.stdh0LunarMean = stdh0LunarMean;
var Stdh0LunarMean = stdh0LunarMean(); // for backward-compatibility
...
var stdh0Lunar = function stdh0Lunar(π, refraction) {
  refraction = refraction || meanRefraction;
  return stdh0.lunar * π - refraction;
};

exports.stdh0Lunar = stdh0Lunar;
var Stdh0Lunar = stdh0Lunar; // for backward-compatibility
...
function _th0(Th0, m) {
  ...
  // Th0 /= 240
  // m /= 86400
  var th0 = _base["default"].pmod(Th0 + m * 360.985647 / 360, SECS_PER_DAY); // p103
...
function _approxTimes(p, h0, Th0, α, δ) {
  ...
  var rs = {};
  rs.transit = _base["default"].pmod(mt, SECS_PER_DAY);
  rs.rise = _base["default"].pmod(mt - H0, SECS_PER_DAY);
  rs.set = _base["default"].pmod(mt + H0, SECS_PER_DAY);
...
function _times(p, ΔT, h0, Th0, α3, δ3) {
  ...
  var d3α = new _interpolation["default"].Len3(-SECS_PER_DAY, SECS_PER_DAY, α3);
  var d3δ = new _interpolation["default"].Len3(-SECS_PER_DAY, SECS_PER_DAY, δ3); // adjust mTransit
  ...
  rs.transit -= H; // adjust mRise, mSet

  var _base$sincos = _base["default"].sincos(p.lat),
...
var PlanetRise = /*#__PURE__*/function () {
  /**
  ...
  function PlanetRise(jd, lat, lon, earth, planet, opts) {
    ...
    if (jd instanceof Date) {
      jd = new _julian["default"].Calendar().fromDate(jd).toJD();
    }
    ...
    this.lon = lon * D2R;
    var cal = new _julian["default"].Calendar().fromJD(this.jd);
    this.jde = cal.toJDE();
    this.ΔT = _deltat["default"].deltaT(cal.toYear());
    this.earth = earth;
    this.planet = planet;
  }
  ...
  _createClass(PlanetRise, [{
    ...
    value: function approxTimes() {
      var body = _elliptic["default"].position(this.planet, this.earth, this.jde);

      var Th0 = _sidereal["default"].apparent0UT(this.jd);

      var rs = _approxTimes({
        lat: this.lat,
        lon: this.lon
      }, this.refraction, Th0, body.ra, body.dec);
    ...
    value: function times() {
      var body = [_elliptic["default"].position(this.planet, this.earth, this.jde - 1), _elliptic["default"].position(this.planet, this.earth, this.jde), _elliptic["default"].position(this.planet, this.earth, this.jde + 1)];
      ...
      var rs = _times({
        lat: this.lat,
        lon: this.lon
      }, this.ΔT, this.refraction, Th0, this._toArr(body, 'ra'), this._toArr(body, 'dec'));
    ...
    value: function _toJD(secs) {
      ...
      if (this.opts.date) {
        return new _julian["default"].Calendar().fromJD(jd).toDate();
      } else {
        return jd;
      }
    }
