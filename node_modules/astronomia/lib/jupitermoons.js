...
exports.e5 = e5;
exports["default"] = exports.callisto = exports.ganymede = exports.europa = exports.io = void 0;
...
function positions(jde) {
  ...
  var _base$sincos = _base["default"].sincos(M),
      _base$sincos2 = _slicedToArray(_base$sincos, 2),
      sM = _base$sincos2[0],
      cM = _base$sincos2[1];

  var _base$sincos3 = _base["default"].sincos(N),
  ...
  var _base$sincos9 = _base["default"].sincos(K),
  ...
  var xy = function xy(u, r) {
    var _base$sincos19 = _base["default"].sincos(u),
...
function e5(jde, earth, jupiter, pos) {
  pos = pos || new Array(4); // variables assigned in following block
  ...
  (function () {
    ...
    var _base$sincos21 = _base["default"].sincos(s),
    ...
    function f() {
      ...
      var _base$sincos23 = _base["default"].sincos(lon),
          _base$sincos24 = _slicedToArray(_base$sincos23, 2),
          sl = _base$sincos24[0],
          cl = _base$sincos24[1];

      var _base$sincos25 = _base["default"].sincos(lat),
  ...
  var L2 = l2 + Σ2;
  var L3 = l3 + Σ3;
  var L4 = l4 + Σ4; // variables assigned in following block
  ...
  (function () {
    ...
    ψ += P;
    var T = (jde - _base["default"].J1900) / _base["default"].JulianCentury;
    I = 3.120262 * p + 0.0006 * p * T;

    for (var _i2 in L) {
      var _base$sincos27 = _base["default"].sincos(L[_i2] - ψ),
          _base$sincos28 = _slicedToArray(_base$sincos27, 2),
          sLψ = _base$sincos28[0],
          cLψ = _base$sincos28[1];

      var _base$sincos29 = _base["default"].sincos(B[_i2]),
  ...
  var _base$sincos31 = _base["default"].sincos(I),
      _base$sincos32 = _slicedToArray(_base$sincos31, 2),
      sI = _base$sincos32[0],
      cI = _base$sincos32[1];

  var Ω = _planetelements["default"].node(_planetelements["default"].jupiter, jde);

  var _base$sincos33 = _base["default"].sincos(Ω),
      _base$sincos34 = _slicedToArray(_base$sincos33, 2),
      sΩ = _base$sincos34[0],
      cΩ = _base$sincos34[1];

  var _base$sincos35 = _base["default"].sincos(ψ - Ω),
      _base$sincos36 = _slicedToArray(_base$sincos35, 2),
      sΦ = _base$sincos36[0],
      cΦ = _base$sincos36[1];

  var _base$sincos37 = _base["default"].sincos(_planetelements["default"].inc(_planetelements["default"].jupiter, jde)),
      _base$sincos38 = _slicedToArray(_base$sincos37, 2),
      si = _base$sincos38[0],
      ci = _base$sincos38[1];

  var _base$sincos39 = _base["default"].sincos(λ0),
      _base$sincos40 = _slicedToArray(_base$sincos39, 2),
      sλ0 = _base$sincos40[0],
      cλ0 = _base$sincos40[1];

  var _base$sincos41 = _base["default"].sincos(β0),
      _base$sincos42 = _slicedToArray(_base$sincos41, 2),
      sβ0 = _base$sincos42[0],
      cβ0 = _base$sincos42[1];

  for (var i in A) {
    var a0 = void 0; // step 1

    var a = X[i];
    var b = Y[i] * cI - Z[i] * sI;
    var c = Y[i] * sI + Z[i] * cI; // step 2
  ...
  var _base$sincos43 = _base["default"].sincos(Math.atan2(A[4], C[4])),
      _base$sincos44 = _slicedToArray(_base$sincos43, 2),
      sD = _base$sincos44[0],
      cD = _base$sincos44[1]; // p. 313


  for (var _i3 = 0; _i3 < 4; _i3++) {
    var x = A[_i3] * cD - C[_i3] * sD;
    var y = A[_i3] * sD + C[_i3] * cD;
    var z = B[_i3]; // differential light time

    var d = x / R[_i3];
    x += Math.abs(z) / k[_i3] * Math.sqrt(1 - d * d); // perspective effect

    var W = Δ / (Δ + z / 2095);
    pos[_i3] = new XY(x * W, y * W);
  }
