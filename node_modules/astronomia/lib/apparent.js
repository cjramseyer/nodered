...
var _nutation6 = _interopRequireDefault(require("./nutation"));
...
function nutation(α, δ, jd) {
  // (α, δ, jd float64)  (Δα1, Δδ1 float64)
  var ε = _nutation6["default"].meanObliquity(jd);
...
function perihelion(T) {
  // (T float64)  float64
  return _base["default"].horner(T, 102.93735, 1.71946, 0.00046) * Math.PI / 180;
}
/**
...
function eclipticAberration(λ, β, jd) {
  ...
  var T = _base["default"].J2000Century(jd);

  var _solar$trueLongitude = _solar["default"].trueLongitude(T),
  ...
  var _base$sincos5 = _base["default"].sincos(β),
      _base$sincos6 = _slicedToArray(_base$sincos5, 2),
      sβ = _base$sincos6[0],
      cβ = _base$sincos6[1];

  var _base$sincos7 = _base["default"].sincos(lon - λ),
      _base$sincos8 = _slicedToArray(_base$sincos7, 2),
      ssλ = _base$sincos8[0],
      csλ = _base$sincos8[1];

  var _base$sincos9 = _base["default"].sincos(π - λ),
      _base$sincos10 = _slicedToArray(_base$sincos9, 2),
      sinπλ = _base$sincos10[0],
      cosπλ = _base$sincos10[1]; // (23.2) p. 151
...
function aberration(α, δ, jd) {
  // (α, δ, jd float64)  (Δα2, Δδ2 float64)
  var ε = _nutation6["default"].meanObliquity(jd);

  var T = _base["default"].J2000Century(jd);

  var _solar$trueLongitude2 = _solar["default"].trueLongitude(T),
...
function position(eqFrom, epochFrom, epochTo, mα, mδ) {
  ...
  var eqTo = _precess["default"].position(eqFrom, epochFrom, epochTo, mα, mδ);

  var jd = _base["default"].JulianYearToJDE(epochTo);

  var _nutation2 = nutation(eqTo.ra, eqTo.dec, jd),
      _nutation3 = _slicedToArray(_nutation2, 2),
      Δα1 = _nutation3[0],
      Δδ1 = _nutation3[1];

  var _aberration = aberration(eqTo.ra, eqTo.dec, jd),
      _aberration2 = _slicedToArray(_aberration, 2),
      Δα2 = _aberration2[0],
      Δδ2 = _aberration2[1];
...
function aberrationRonVondrak(α, δ, jd) {
  ...
  var Xp = 0;
  var Yp = 0;
  var Zp = 0; // sum smaller terms first
...
var rvTerm = [function (r) {
  // 1
  var _base$sincos23 = _base["default"].sincos(r.L3),
  ...
  // 2
  var _base$sincos25 = _base["default"].sincos(2 * r.L3),
  ...
  // 3
  var _base$sincos27 = _base["default"].sincos(r.L5),
  ...
  // 4
  var _base$sincos29 = _base["default"].sincos(r.Lp),
  ...
  // 5
  var _base$sincos31 = _base["default"].sincos(3 * r.L3),
  ...
  // 6
  var _base$sincos33 = _base["default"].sincos(r.L6),
  ...
  // 8
  var _base$sincos35 = _base["default"].sincos(r.Lp + r.Mp),
  ...
  // 9
  var _base$sincos37 = _base["default"].sincos(2 * r.L5),
  ...
  // 10
  var _base$sincos39 = _base["default"].sincos(2 * r.L3 - r.L5),
  ...
  // 11
  var _base$sincos41 = _base["default"].sincos(3 * r.L3 - 8 * r.L4 + 3 * r.L5),
  ...
  // 12
  var _base$sincos43 = _base["default"].sincos(5 * r.L3 - 8 * r.L4 + 3 * r.L5),
  ...
  // 13
  var _base$sincos45 = _base["default"].sincos(2 * r.L2 - r.L3),
  ...
  // 14
  var _base$sincos47 = _base["default"].sincos(r.L2),
  ...
  // 15
  var _base$sincos49 = _base["default"].sincos(r.L7),
  ...
  // 16
  var _base$sincos51 = _base["default"].sincos(r.L3 - 2 * r.L5),
  ...
  // 17
  var _base$sincos53 = _base["default"].sincos(r.L8),
  ...
  // 18
  var _base$sincos55 = _base["default"].sincos(r.L3 + r.L5),
  ...
  // 19
  var _base$sincos57 = _base["default"].sincos(2 * r.L2 - 2 * r.L3),
  ...
  // 20
  var _base$sincos59 = _base["default"].sincos(r.L3 - r.L5),
  ...
  // 21
  var _base$sincos61 = _base["default"].sincos(4 * r.L3),
  ...
  // 22
  var _base$sincos63 = _base["default"].sincos(3 * r.L3 - 2 * r.L5),
  ...
  // 23
  var _base$sincos65 = _base["default"].sincos(r.L2 - 2 * r.L3),
  ...
  // 24
  var _base$sincos67 = _base["default"].sincos(2 * r.L2 - 3 * r.L3),
  ...
  // 25
  var _base$sincos69 = _base["default"].sincos(2 * r.L6),
  ...
  // 26
  var _base$sincos71 = _base["default"].sincos(2 * r.L2 - 4 * r.L3),
  ...
  // 27
  var _base$sincos73 = _base["default"].sincos(3 * r.L3 - 2 * r.L4),
  ...
  // 28
  var _base$sincos75 = _base["default"].sincos(r.Lp + 2 * r.D - r.Mp),
  ...
  // 29
  var _base$sincos77 = _base["default"].sincos(8 * r.L2 - 12 * r.L3),
  ...
  // 30
  var _base$sincos79 = _base["default"].sincos(8 * r.L2 - 14 * r.L3),
  ...
  // 31
  var _base$sincos81 = _base["default"].sincos(2 * r.L4),
  ...
  // 32
  var _base$sincos83 = _base["default"].sincos(3 * r.L2 - 4 * r.L3),
  ...
  // 33
  var _base$sincos85 = _base["default"].sincos(2 * r.L3 - 2 * r.L5),
  ...
  // 34
  var _base$sincos87 = _base["default"].sincos(3 * r.L2 - 3 * r.L3),
  ...
  // 35
  var _base$sincos89 = _base["default"].sincos(2 * r.L3 - 2 * r.L4),
  ...
  // 36
  var _base$sincos91 = _base["default"].sincos(r.Lp - 2 * r.D),
...
function positionRonVondrak(eqFrom, epochTo, mα, mδ) {
  ...
  var _aberrationRonVondrak = aberrationRonVondrak(eqTo.ra, eqTo.dec, jd),
      _aberrationRonVondrak2 = _slicedToArray(_aberrationRonVondrak, 2),
      Δα = _aberrationRonVondrak2[0],
      Δδ = _aberrationRonVondrak2[1];

  eqTo.ra += Δα;
  eqTo.dec += Δδ;
  eqTo = _precess["default"].position(eqTo, 2000, epochTo, 0, 0);

  var _nutation4 = nutation(eqTo.ra, eqTo.dec, jd),
      _nutation5 = _slicedToArray(_nutation4, 2),
      Δα1 = _nutation5[0],
      Δδ1 = _nutation5[1];
