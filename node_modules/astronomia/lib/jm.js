...
function JewishCalendar(y) {
  ...
  var y1 = y + 1;
  var lf = _julian["default"].LeapYearGregorian;

  if (y1 < 1583) {
    lf = _julian["default"].LeapYearJulian;
  }
...
var bigD = function bigD(y) {
  // (y int)  int
  var C = _base["default"].floorDiv(y, 100); // const S int


  var S = 0;

  if (y >= 1583) {
    S = _int(_base["default"].floorDiv(3 * C - 5, 4));
  }
...
function MoslemToJD(y, m, d) {
  // (y, m, d int)  (jY, jDN int)
  var N = d + _base["default"].floorDiv(295001 * (m - 1) + 9900, 10000);

  var Q = _base["default"].floorDiv(y, 30);

  var R = y % 30;

  var A = _base["default"].floorDiv(11 * R + 3, 30);

  var W = 404 * Q + 354 * R + 208 + A;

  var Q1 = _base["default"].floorDiv(W, 1461);

  var Q2 = W % 1461;
  var G = 621 + 28 * Q + 4 * Q1;

  var K = _base["default"].floorDiv(Q2 * 10000, 3652422);

  var E = _base["default"].floorDiv(3652422 * K, 10000);
  ...
  var jd = _base["default"].floorDiv(36525 * (X - 1), 100) + 1721423 + J;
  return jd;
}
/**
...
function JulianToMoslem(y, m, d) {
  ...
  var N = _base["default"].floorDiv(275 * m, 9) - W * _base["default"].floorDiv(m + 9, 12) + d - 30;

  var A = _int(y - 623);

  var B = _base["default"].floorDiv(A, 4);
  ...
  var Q = _base["default"].floorDiv(Dp, 10631);

  var R = Dp % 10631;

  var J = _base["default"].floorDiv(R, 354);

  var K = R % 354;

  var O = _base["default"].floorDiv(11 * J + 14, 30);
  ...
  if (JJ === 355) {
    ...
    var S = _base["default"].floorDiv((JJ - 1) * 10, 295);

    mm = 1 + S;
    md = _base["default"].floorDiv(10 * JJ - 295 * S, 10);
  }
...
var _default = {
  ...
  MoslemToJD: MoslemToJD,
  MoslemLeapYear: MoslemLeapYear,
  JulianToMoslem: JulianToMoslem,
  moslemMonth: moslemMonth
};
