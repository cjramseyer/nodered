...
exports.inc = inc;
exports.node = node;
exports["default"] = exports.neptune = exports.uranus = exports.saturn = exports.jupiter = exports.mars = exports.earth = exports.venus = exports.mercury = void 0;
...
function mean(p, jde, e) {
  ...
  var c = cMean[p];
  e = e || new Elements();
  e.lon = _base["default"].pmod(_base["default"].horner(T, c.L) * Math.PI / 180, 2 * Math.PI);
  e.axis = _base["default"].horner(T, c.a);
  e.ecc = _base["default"].horner(T, c.e);
  e.inc = _base["default"].horner(T, c.i) * Math.PI / 180;
  e.node = _base["default"].horner(T, c.Ω) * Math.PI / 180;
  e.peri = _base["default"].horner(T, c.ϖ) * Math.PI / 180;
  return e;
}
/**
...
function inc(p, jde) {
  // (p int, jde float64)  float64
  return _base["default"].horner(_base["default"].J2000Century(jde), cMean[p].i) * Math.PI / 180;
}
/**
...
function node(p, jde) {
  // (p int, jde float64)  float64
  return _base["default"].horner(_base["default"].J2000Century(jde), cMean[p].Ω) * Math.PI / 180;
}
