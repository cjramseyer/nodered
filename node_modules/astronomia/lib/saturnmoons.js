...
exports.Qs = Qs;
exports["default"] = exports.iapetus = exports.hyperion = exports.titan = exports.rhea = exports.dione = exports.tethys = exports.enceladus = exports.mimas = void 0;
...
function positions(jde, earth, saturn) {
  var sol = _solar["default"].trueVSOP87(earth, jde);
  ...
  var _base$sincos = _base["default"].sincos(s),
  ...
  var f = function f() {
    var τ = _base["default"].lightTime(Δ);
    ...
    var fk5 = _planetposition["default"].toFK5(lon, lat, _jde);

    var _ref2 = [fk5.lon, fk5.lat],
        l = _ref2[0],
        b = _ref2[1];

    var _base$sincos3 = _base["default"].sincos(l),
        _base$sincos4 = _slicedToArray(_base$sincos3, 2),
        sl = _base$sincos4[0],
        cl = _base$sincos4[1];

    var _base$sincos5 = _base["default"].sincos(b),
  ...
  var ecl = new _coord["default"].Ecliptic(λ0, β0);
  ecl = _precess["default"].eclipticPosition(ecl, _base["default"].JDEToJulianYear(jde), _base["default"].JDEToJulianYear(_base["default"].B1950), 0, 0);
  λ0 = ecl.lon;
  β0 = ecl.lat;
  var q = new Qs(_jde);
  ...
  for (var j = 1; j <= 8; j++) {
    ...
    var _base$sincos7 = _base["default"].sincos(u),
    ...
    var _base$sincos11 = _base["default"].sincos(s4[j].γ),
  ...
  for (var _j2 = 1; _j2 <= 8; _j2++) {
    ...
    var _d2 = X[_j2] / s4[_j2].r;

    X[_j2] += Math.abs(Z[_j2]) / k[_j2] * Math.sqrt(1 - _d2 * _d2);
...
Qs.prototype.rhea = function () {
  ...
  var _base$sincos19 = _base["default"].sincos(pʹ),
  ...
  var _base$sincos21 = _base["default"].sincos(N),
...
Qs.prototype.subr = function (λʹ, p, e, a, Ω, i) {
  ...
  var _base$sincos23 = _base["default"].sincos(i),
      _base$sincos24 = _slicedToArray(_base$sincos23, 2),
      si = _base$sincos24[0],
      ci = _base$sincos24[1];

  var _base$sincos25 = _base["default"].sincos(g),
...
Qs.prototype.titan = function () {
  ...
  var _base$sincos27 = _base["default"].sincos(iʹ),
      _base$sincos28 = _slicedToArray(_base$sincos27, 2),
      siʹ = _base$sincos28[0],
      ciʹ = _base$sincos28[1];

  var _base$sincos29 = _base["default"].sincos(Ωʹ - this.W8),
  ...
  var _base$sincos31 = _base["default"].sincos(2 * g0),
  ...
  var _base$sincos33 = _base["default"].sincos(qq),
  ...
  var _base$sincos35 = _base["default"].sincos(u),
...
Qs.prototype.iapetus = function () {
  ...
  var iʹ = _base["default"].horner(this.t11, 18.4602 * d, -0.9518 * d, -0.072 * d, 0.0054 * d);

  var Ωʹ = _base["default"].horner(this.t11, 143.198 * d, -3.919 * d, 0.116 * d, 0.008 * d);
