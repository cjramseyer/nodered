...
exports["default"] = exports.MOON_RADIUS = exports.EARTH_RADIUS = void 0;
...
var ck = 1 / 1325.55;
var D2R = Math.PI / 180; // from http://nssdc.gsfc.nasa.gov/planetary/factsheet/earthfact.html
...
var mean = function mean(T) {
  return _base["default"].horner(T, 2451534.6698, 27.55454989 / ck, -0.0006691, -0.000001098, 0.0000000052);
};
/**
...
var snap = function snap(y, h) {
  var k = (y - 1999.97) * 13.2555; // (50.2) p. 355
...
var La = /*#__PURE__*/function () {
  function La(y, h) {
    ...
    this.D = _base["default"].horner(this.T, 171.9179 * D2R, 335.9106046 * D2R / ck, -0.0100383 * D2R, -0.00001156 * D2R, 0.000000055 * D2R);
    this.M = _base["default"].horner(this.T, 347.3477 * D2R, 27.1577721 * D2R / ck, -0.000813 * D2R, -0.000001 * D2R);
    this.F = _base["default"].horner(this.T, 316.6109 * D2R, 364.5287911 * D2R / ck, -0.0125053 * D2R, -0.0000148 * D2R);
    return this;
  }
  /**
   * perigee correction
  ...
  _createClass(La, [{
    ...
    key: "apogeeParallax",
    value: function apogeeParallax() {
      var s = Math.PI / 180 / 3600;
      var l = this;
      return 3245.251 * s + -9.147 * s * cos(2 * l.D) + -0.841 * s * cos(l.D) + 0.697 * s * cos(2 * l.F) + (-0.656 * s + 0.0016 * s * l.T) * cos(l.M) + 0.355 * s * cos(4 * l.D) + 0.159 * s * cos(2 * l.D - l.M) + 0.127 * s * cos(l.D + l.M) + 0.065 * s * cos(4 * l.D - l.M) + 0.052 * s * cos(6 * l.D) + 0.043 * s * cos(2 * l.D + l.M) + 0.031 * s * cos(2 * (l.D + l.F)) + -0.023 * s * cos(2 * (l.D - l.F)) + 0.022 * s * cos(2 * (l.D - l.M)) + 0.019 * s * cos(2 * (l.D + l.M)) + -0.016 * s * cos(2 * l.M) + 0.014 * s * cos(6 * l.D - l.M) + 0.01 * s * cos(8 * l.D);
    }
    /**
     * perigee parallax
     */
...
var _default = {
  ...
  apogee: apogee,
  apogeeParallax: apogeeParallax,
  perigeeParallax: perigeeParallax,
  distance: distance
};
