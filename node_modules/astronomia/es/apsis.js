...
export var EARTH_RADIUS = 6378.137; // km
// from http://nssdc.gsfc.nasa.gov/planetary/factsheet/moonfact.html

export var MOON_RADIUS = 1738.1; // km
...
export function meanApogee(year) {
...
var La = /*#__PURE__*/function () {
  function La(y, h) {
    ...
    this.D = base.horner(this.T, 171.9179 * D2R, 335.9106046 * D2R / ck, -0.0100383 * D2R, -0.00001156 * D2R, 0.000000055 * D2R);
    this.M = base.horner(this.T, 347.3477 * D2R, 27.1577721 * D2R / ck, -0.000813 * D2R, -0.000001 * D2R);
    this.F = base.horner(this.T, 316.6109 * D2R, 364.5287911 * D2R / ck, -0.0125053 * D2R, -0.0000148 * D2R);
    return this;
  }
  /**
   * perigee correction
  ...
  var _proto = La.prototype;

  _proto.perigeeCorr = function perigeeCorr() {
    var l = this;
  ...
  _proto.apogeeCorr = function apogeeCorr() {
    var l = this;
  ...
  _proto.apogeeParallax = function apogeeParallax() {
  ...
  _proto.perigeeParallax = function perigeeParallax() {
    var s = Math.PI / 180 / 3600;
    var l = this;
