...
export var K = 0.01720209895; // K from ch 33, p. 228, for example

/** AU is one astronomical unit in km. */

export var AU = 149597870; // from Appendix I, p, 407.

/** SOblJ2000 sine obliquity at J2000. */

export var SOblJ2000 = 0.397777156;
/** COblJ2000 cosine obliquity at J2000. */

export var COblJ2000 = 0.917482062; // SOblJ2000, COblJ2000 from ch 33, p. 228, for example
...
export var JMod = 2400000.5;
/** J2000 is the Julian date corresponding to January 1.5, year 2000. */

export var J2000 = 2451545.0; // Julian days of common epochs.
// B1900, B1950 from p. 133

/** Julian days of Julian epoch 1900 */

export var J1900 = 2415020.0;
/** Julian days of Besselian epoch 1900 */

export var B1900 = 2415020.3135;
/** Julian days of Besselian epoch 1950 */

export var B1950 = 2433282.4235; // JulianYear and other common periods

/** JulianYear in days */

export var JulianYear = 365.25; // days

/** JulianCentury in days */

export var JulianCentury = 36525; // days

/** BesselianYear in days; equals mean tropical year */

export var BesselianYear = 365.2421988; // days

/** Mean sidereal year */

export var meanSiderealYear = 365.25636; // days
...
export var SmallAngle = 10 * Math.PI / 180 / 60; // about .003 radians

/** cosine of SmallAngle */

export var CosSmallAngle = Math.cos(SmallAngle); // about .999996
