...
export var iau82 = [24110.54841, 8640184.812866, 0.093104, -0.0000062];
/**
...
export function mean0UT(jd
/* float */
) {
  var _mean0UT3 = _mean0UT(jd),
      s = _mean0UT3[0],
      _ = _mean0UT3[1]; // eslint-disable-line
...
export function apparent0UT(jd) {
  var _base$modf2 = base.modf(jd + 0.5),
      j0 = _base$modf2[0],
      f = _base$modf2[1];
