...
export function deltaT(dyear) {
  ...
  if (dyear < -500) {
    ...
    ΔT = base.horner(dyear * 0.01, 10583.6, -1014.41, 33.78311, -5.952053, -0.1798452, 0.022174192, 0.0090316521);
  } else if (dyear < 1600) {
    ΔT = base.horner((dyear - 1000) * 0.01, 1574.2, -556.01, 71.23472, 0.319781, -0.8503463, -0.005050998, 0.0083572073);
...
function interpolateData(dyear, data) {
  var _data$firstYM = data.firstYM,
