...
function cosEq(α, δ, α0, δ0) {
  ...
  var _base$sincos2 = base.sincos(δ0),
      sδ0 = _base$sincos2[0],
      cδ0 = _base$sincos2[1];
...
export function phaseAngle3(jde) {
  // (jde float64)  float64
  ...
  return Math.PI - base.pmod(D, 2 * Math.PI) + -6.289 * D2R * Math.sin(m_) + 2.1 * D2R * Math.sin(m) + -1.274 * D2R * Math.sin(2 * D - m_) + -0.658 * D2R * Math.sin(2 * D) + -0.214 * D2R * Math.sin(2 * m_) + -0.11 * D2R * Math.sin(D);
}
export default {
