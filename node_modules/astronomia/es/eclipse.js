...
var g = function g(k, jm, c1, c2) {
  ...
  var A1 = base.horner(T, 299.77 * p, 0.107408 * p / ck, -0.009173 * p); // (54.1) p. 380
...
export function solar(year) {
  ...
  var _g = g(snap(year, 0), moonphase.meanNew(year), -0.4075, 0.1721),
      ...
      γ = _g[2],
      u = _g[3],
      _ = _g[4]; // eslint-disable-line no-unused-vars
...
export function lunar(year) {
  ...
  var _g2 = g(snap(year, 0.5), moonphase.meanFull(year), -0.4065, 0.1727),
      e = _g2[0],
      jdeMax = _g2[1],
      γ = _g2[2],
      u = _g2[3],
