 ...
 */
import base from './base'; // planet names used in cMean

export var mercury = 'mercury';
export var venus = 'venus';
export var earth = 'earth';
export var mars = 'mars';
export var jupiter = 'jupiter';
export var saturn = 'saturn';
export var uranus = 'uranus';
export var neptune = 'neptune';
/**
