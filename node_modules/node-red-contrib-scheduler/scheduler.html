...
<script type="text/x-red" data-help-name="scheduler">
    <p>Scheduler sends messages for start and end conditions at any time, day, month or period.</p>
	<p>The first output sends out a message on time (and if repeat is ticked - repeats that every minute) - the second output simply sends the state - 1 or 0. The third output sends an optional message for both states - suitable for speech output or a log</p>
</script>
	...
	<br/><br/>
	<div>
		<span style="width: 150px; float: left; margin-left: 5px;"><input type="checkbox" id="node-input-repeat" placeholder="repeat" >Repeat</span>
		<span style="width: 150px; float: left; margin-left: 5px;"><input type="checkbox" id="node-input-atstart" placeholder="atstart" >At startup</span>
		<br/><br/>
	</div>
