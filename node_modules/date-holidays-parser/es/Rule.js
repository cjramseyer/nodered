...
var Rule = /*#__PURE__*/function () {
  ...
  * @param {CalEvent} [calEvent]
  ...
  _proto.setEvent = function setEvent(calEvent) {
    this.calEvent = calEvent;
    return this;
  }
  /**
  ...
  _proto.setModifier = function setModifier(modifier) {
  ...
  _proto.resolve = function resolve(rule) {
  ...
  _proto.dateDir = function dateDir(rule) {
  ...
  _proto.dateIfThen = function dateIfThen(rule) {
    var _this = this;
  ...
  _proto.weekday = function weekday(rule) {
    this.calEvent.dates = this.calEvent.dates.map(function (date) {
      var weekday = date.getDay();
  ...
  _proto.time = function time(rule) {
    this.calEvent.dates.forEach(function (date) {
      date.setTime(rule.hour, rule.minute);
    });
  };

  _proto.duration = function duration(rule) {
    this.calEvent.dates.forEach(function (date) {
      date.duration = rule.duration;
    });
  };

  _proto.bridge = function bridge() {
  ...
  _proto.year = function year(rule) {
    var _this2 = this;
  ...
  _proto._isLeapYear = function _isLeapYear(year) {
