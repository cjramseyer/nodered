...
var Parser = /*#__PURE__*/function () {
  ...
  _proto.parse = function parse(rule) {
    this.setup = {
      str: rule,
      rule: rule
    };
  ...
  _proto._reorder = function _reorder() {
    var tmp = [];
    var res = [];
  ...
  _proto._tokenize = function _tokenize(o) {
    var last;
  ...
  _proto._shorten = function _shorten(o, cap0) {
    o.str = o.str.substr(cap0.length, o.str.length);
  };

  _proto._date = function _date(o) {
    var cap;
  ...
  _proto._julian = function _julian(o) {
    var cap;
  ...
  _proto._easter = function _easter(o) {
    var cap;
  ...
  _proto._equinox = function _equinox(o) {
    var cap;
  ...
  _proto._hebrew = function _hebrew(o) {
    var cap;
  ...
  _proto._islamic = function _islamic(o) {
    var cap;
  ...
  _proto._chineseSolar = function _chineseSolar(o) {
    var cap;
  ...
  _proto._chineseLunar = function _chineseLunar(o) {
    var cap;
  ...
  _proto._bengaliRevised = function _bengaliRevised(o) {
    var cap;
  ...
  _proto._dateMonth = function _dateMonth(o) {
    var cap;
  ...
  _proto._space = function _space(o) {
    var cap;
  ...
  _proto._ruleSameDay = function _ruleSameDay(o) {
    var cap;
  ...
  _proto._ruleModifier = function _ruleModifier(o) {
    var cap;
  ...
  _proto._ruleTime = function _ruleTime(o) {
    var cap;
  ...
  _proto._ruleDuration = function _ruleDuration(o) {
    var cap;
  ...
  _proto._ruleDateIfThen = function _ruleDateIfThen(o) {
    var cap;
  ...
  _proto._ruleWeekday = function _ruleWeekday(o) {
    var cap;
  ...
  _proto._ruleDateDir = function _ruleDateDir(o) {
    var cap;
  ...
  _proto._ruleYear = function _ruleYear(o) {
    var cap;
  ...
  _proto._ruleBridge = function _ruleBridge(o) {
    var cap;
